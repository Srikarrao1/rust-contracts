...
mod exec {
    use super::*;
    use cosmwasm_std::{BankMsg, Event, StdError};
    ...
    pub fn add_members(
        ...
        let resp = Response::new()
            ...
            .add_attribute("added count", admins.len().to_string());
    ...
    pub fn donate(deps: DepsMut, info: MessageInfo) -> Result<Response, ContractError> {
        ...
        let donation = cw_utils::must_pay(&info, &denom).unwrap().u128();
...
mod test {
    ...
    use crate::{
        instantiate,
        msg::{AdminsListResp, ExecuteMsg, GreetResp, InstantiateMsg},
        query, QueryMsg,
    };
